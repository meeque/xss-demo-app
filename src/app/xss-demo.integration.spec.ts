...
describe('Xss Demo App', async () => {
  ...
  presetsTestConfigsByContextAndOutput[XssContext.JavaScript.toString()] = {
    ...
    'BlockDomStorageMockIframe': [cf.newWindow('JS code breaking "string"'), cf.newWindow('JS code breaking \'string\''), cf.newWindow('pure JS code'), cf.newWindow('pure JS defacement attack'), cf.skip('JS attack on a plain HTML page (window)'),      cf.skip('JS attack on browser storage (window)'),      cf.skip('JS attack on cookies (window)'),      cf.newWindow('JSFuck'), cf.newWindowXss('pure JS code for parent and opener')],
    'BlockDomCookiesMockIframe': [cf.newWindow('JS code breaking "string"'), cf.newWindow('JS code breaking \'string\''), cf.newWindow('pure JS code'), cf.newWindow('pure JS defacement attack'), cf.skip('JS attack on a plain HTML page (window)'),      cf.skip('JS attack on browser storage (window)'),      cf.skip('JS attack on cookies (window)'),      cf.newWindow('JSFuck'), cf.newWindowXss('pure JS code for parent and opener')],
  };
