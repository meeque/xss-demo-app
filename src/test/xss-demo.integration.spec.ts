...
describe('Xss Demo App', async () => {
  ...
  presetsTestConfigsByContextAndOutput[XssContext.JavaScript.toString()] = {
    ...
    'BlockDomTrusted':           ['pure JS code',               'pure JS code for parent and opener',                                                                                                                                                                                  cf.newWindow('Interact with Plain HTML mock (window)'),                                                              cf.newWindow('Interact with Browser Storage mock (window)'),                                                      cf.newWindow('Interact with Cookies mock (window)'), 'JSFuck',               cf.deface('pure JS defacement attack')         ],
    'BlockDomPlainMockIframe':   [cf.newWindow('pure JS code'), cf.newWindowXss('pure JS code for parent and opener'), cf.newWindow('JS code breaking "string" literal'), cf.newWindow('JS code breaking \'string\' literal'),                                                         cf.skip('Interact with Plain HTML mock (window)'),                                                                   cf.skip('Interact with Browser Storage mock (window)'),                                                           cf.skip('Interact with Cookies mock (window)'),      cf.newWindow('JSFuck'), cf.defaceIframe('pure JS defacement attack')   ],
    'BlockDomPlainMockWindow':   [cf.newWindow('pure JS code'), cf.newWindowXss('pure JS code for parent and opener'), cf.newWindow('JS code breaking "string" literal'), cf.newWindow('JS code breaking \'string\' literal'), cf.newWindow('Interact with Plain HTML mock (iframe)'), cf.skip('Interact with Plain HTML mock (window)'),      cf.newWindow('Interact with Browser Storage mock (iframe)'), cf.skip('Interact with Browser Storage mock (window)'),      cf.newWindow('Interact with Cookies mock (iframe)'), cf.skip('Interact with Cookies mock (window)'),      cf.newWindow('JSFuck'), cf.defaceNewWindow('pure JS defacement attack')],
